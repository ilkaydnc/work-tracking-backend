...
export class PartnerService {
  ...
  async getPartnerByID(id: string): Promise<Partner> {
    ...
    if (!partner) throw new NotFoundException(`Not found partner with this ID: ${id}`)

    return partner
  }

  async createPartner(createPartnerInput: CreatePartnerInput): Promise<Partner> {
  ...
  async updatePartner(updatePartnerInput: UpdatePartnerInput): Promise<Partner> {
